...
public class StatusRastreio implements Serializable{
	...
	public String getCentroDistribuição() {
		return centroDistribuição;
	}

	public void setCentroDistribuição(String centroDistribuição) {
		this.centroDistribuição = centroDistribuição;
	}
